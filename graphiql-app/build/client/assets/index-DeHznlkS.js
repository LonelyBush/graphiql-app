...
function Tr(e, t, r) {
  ...
  if (t != null)
    ...
    t))
      Fr.call(t, n) && !Ur.hasOwnProperty(n) && (a[n] = t[n]);
...
function vt(e, t, r, n, a) {
  ...
  if (((i = 0), (n = n === '' ? '.' : n + ':'), lr(e)))
    ...
    for (e = u.call(e), c = 0; !(l = e.next()).done; )
      (l = l.value), (u = n + _t(l, c++)), (i += vt(l, t, r, u, a));
  else if (l === 'object')
    throw (
      ((t = String(e)),
      Error(
...
j.cloneElement = function (e, t, r) {
  ...
  if (t != null) {
    if (
      (t.ref !== void 0 && ((l = t.ref), (i = At.current)),
...
function $n(e, t, r, n) {
  ...
  let E = {
    ...
    listen(P) {
      ...
      return (
        a.addEventListener(ur, f),
        (u = P),
        () => {
          a.removeEventListener(ur, f), (u = null);
        }
      );
    },
    createHref(P) {
...
function kr(e, t, r, n) {
  ...
  return (
    e.forEach((l, i) => {
      ...
      else for (let u of Br(l.path)) a(l, i, u);
    }),
    t
  );
}
  ...
  typeof e == 'string'
    ...
    : ((a = H({}, e)),
      L(
        ...
        Ct('?', 'pathname', 'search', a),
      ),
      L(
        !a.pathname || !a.pathname.includes('#'),
        Ct('#', 'pathname', 'hash', a),
      ),
      L(!a.search || !a.search.includes('#'), Ct('#', 'search', 'hash', a)));
  let l = e === '' || a.pathname === '',
    i = l ? '/' : a.pathname,
    c;
  if (i == null) c = r;
...
class oo {
  constructor(t, r) {
    ...
    let a = () => n(new jt('Deferred data aborted'));
  ...
  onSettle(t, r, n, a) {
    if (this.controller.signal.aborted && n instanceof jt)
      return (
        this.unlistenAbortSignal(),
...
function lo(e) {
  ...
  let l = {},
    ...
    K = _e(i, e.history.location, u),
    oe = null;
  if (K == null && !m) {
    let o = Z(404, { pathname: e.history.location.pathname }),
      { matches: s, route: d } = Rr(i);
    (K = s), (oe = { [d.id]: o });
  }
  K &&
    !e.hydrationData &&
  ...
  function Zr() {
    ...
    return h.initialized || De(Y.Pop, h.location, { initialHydration: !0 }), $e;
  }
  function en() {
    y && y(),
      ie && ie(),
  ...
  function Fe(o, s, d) {
    ...
    s.actionData
      ...
      : S
        ...
        : (g = null);
    let _ = s.loaderData
        ? wr(h.loaderData, s.loaderData, s.matches || [], s.errors)
        : h.loaderData,
      x = h.blockers;
    ...
    q(
      H({}, s, {
        ...
        navigation: Mt,
        revalidation: 'idle',
        restoreScrollPosition: nr(o, s.matches || h.matches),
  ...
  async function Jt(o, s) {
    ...
    let d = Ft(
      ...
      ),
      {
        ...
        submission: b,
        error: R,
      } = hr(f.v7_normalizeFormMethod, !1, d, s),
      S = h.location,
    ...
    let C =
      ...
      U = tr({ currentLocation: S, nextLocation: g, historyAction: x });
    if (U) {
      lt(U, {
        state: 'blocked',
        location: g,
  ...
  function rn() {
    if (
      ...
      if (h.navigation.state === 'idle') {
        De(h.historyAction, h.location, { startUninterruptedRevalidation: !0 });
        return;
      }
      De(z || h.historyAction, h.navigation.location, {
        overrideNavigation: h.navigation,
      });
    }
  }
  async function De(o, s, d) {
    A && A.abort(),
      (A = null),
      (z = o),
      (Le = (d && d.startUninterruptedRevalidation) === !0),
    ...
    if ((g.active && g.matches && (R = g.matches), !R)) {
      let { error: F, notFoundMatches: X, route: J } = Pt(s.pathname);
      Fe(
        s,
    ...
    if (
      ...
      Fe(s, { matches: R }, { flushSync: S });
      return;
    }
    A = new AbortController();
    let _ = Ae(e.history, s, A.signal, d && d.submission),
      x;
    if (d && d.pendingError)
      x = [Ne(R).route.id, { type: I.error, error: d.pendingError }];
    ...
    C ||
      ((A = null),
      Fe(s, H({ matches: T || R }, Er(x), { loaderData: U, errors: N })));
  }
  async function nn(o, s, d, p, b, R) {
    ...
    if ((q({ navigation: S }, { flushSync: R.flushSync === !0 }), b)) {
      ...
      if (x.type === 'error') {
        ...
        let { notFoundMatches: C, error: T, route: U } = Pt(s.pathname);
        return {
          matches: C,
    ...
    if (Me(g)) {
      ...
      return (
        R && R.replace != null
          ? (x = R.replace)
          : (x =
              yr(g.response.headers.get('Location'), new URL(o.url), u) ===
              h.location.pathname + h.location.search),
        await Ke(o, g, { submission: d, replace: x }),
        { shortCircuited: !0 }
      );
    }
    if (Ce(g)) throw Z(400, { type: 'defer-action' });
    if (re(g)) {
      let x = Ne(p, _.route.id);
      return (
  ...
  async function an(o, s, d, p, b, R, S, g, _, x, C) {
    ...
    if (p) {
      ...
      if (M.type === 'error') {
        ...
        let { error: W, notFoundMatches: te, route: $ } = Pt(s.pathname);
    ...
    J.forEach((M) => {
      V.has(M.key) && ge(M.key), M.controller && V.set(M.key, M.controller);
    });
    let Je = () => J.forEach((M) => ge(M.key));
    A && A.signal.addEventListener('abort', Je);
    let { loaderResults: be, fetcherResults: Ue } = await Gt(
      h.matches,
      d,
      X,
      J,
    ...
    if (Te) {
      if (Te.idx >= X.length) {
        let M = J[Te.idx - X.length].key;
        de.add(M);
      }
      return await Ke(o, Te.result, { replace: g }), { shortCircuited: !0 };
    }
    let { loaderData: Ie, errors: ce } = br(h, d, X, be, C, J, Ue, Se);
    Se.forEach((M, W) => {
      M.subscribe((te) => {
        (te || M.done) && Se.delete(W);
      });
    }),
    ...
    let dt = qt(),
      ...
      ht = dt || ft || J.length > 0;
    return H(
      { matches: d, loaderData: Ie, errors: ce },
  ...
  function ln(o, s, d, p) {
    ...
    let {
      ...
      submission: C,
      error: T,
    } = hr(f.v7_normalizeFormMethod, !0, S, p);
    if (T) {
    ...
    Oe.set(o, { routeId: s, path: x }), un(o, s, x, U, g, _.active, b, C);
  }
  async function sn(o, s, d, p, b, R, S, g) {
    ...
    ye(o, Ua(g, x), { flushSync: S });
    let C = new AbortController(),
      T = Ae(e.history, d, C.signal, g);
    if (R) {
    ...
    if (f.v7_fetcherPersist && fe.has(o)) {
      ...
      if (Me(F))
        if ((V.delete(o), He > U)) {
          ...
          return de.add(o), ye(o, Ge(g)), Ke(T, F, { fetcherSubmission: g });
      if (re(F)) {
        he(o, s, F.error);
        return;
      }
    }
    if (Ce(F)) throw Z(400, { type: 'defer-action' });
    let X = h.navigation.location || h.location,
      J = Ae(e.history, X, C.signal),
      Je = c || i,
      be =
        h.navigation.state !== 'idle'
          ? _e(Je, h.navigation.location, u)
          : h.matches;
    ...
    ce
      ...
      .forEach(($) => {
        let pe = $.key,
          or = h.fetchers.get(pe),
          mn = Ge(void 0, or ? or.data : void 0);
        h.fetchers.set(pe, mn),
          V.has(pe) && ge(pe),
          $.controller && V.set(pe, $.controller);
      }),
      q({ fetchers: new Map(h.fetchers) });
    let dt = () => ce.forEach(($) => ge($.key));
    C.signal.addEventListener('abort', dt);
    let { loaderResults: ft, fetcherResults: ht } = await Gt(
      h.matches,
      be,
      Ie,
      ce,
    ...
    if (M) {
      if (M.idx >= Ie.length) {
        let $ = ce[M.idx - Ie.length].key;
        de.add($);
      }
      return Ke(J, M.result);
    }
    let { loaderData: W, errors: te } = br(
      h,
      h.matches,
      Ie,
      ft,
    ...
    Zt(Ue),
      h.navigation.state === 'loading' && Ue > He
        ...
        : (q({
            errors: te,
            loaderData: wr(h.loaderData, W, be, te),
            fetchers: new Map(h.fetchers),
          }),
          (xe = !1));
  }
  async function un(o, s, d, p, b, R, S, g) {
    ...
    ye(o, Ge(g, _ ? _.data : void 0), { flushSync: S });
    let x = new AbortController(),
      C = Ae(e.history, d, x.signal);
    if (R) {
    ...
    if (
      (Ce(N) && (N = (await Yr(N, C.signal, !0)) || N),
      ...
      L(!Ce(N), 'Unhandled fetcher deferred data'), ye(o, we(N.data));
    }
  }
  ...
  function it(o) {
    ...
    V.has(o) && !(s && s.state === 'loading' && je.has(o)) && ge(o),
      Oe.delete(o),
      je.delete(o),
      de.delete(o),
      fe.delete(o),
    ...
    for (let [d, p] of je)
      if (p < o) {
        ...
        L(b, 'Expected fetcher: ' + d),
          b.state === 'loading' && (ge(d), je.delete(d), s.push(d));
      }
    return Qt(s), s.length > 0;
  }
  function dn(o, s) {
    let d = h.blockers.get(o) || Ye;
    return Pe.get(o) !== s && Pe.set(o, s), d;
  }
  function er(o) {
    h.blockers.delete(o), Pe.delete(o);
  }
  function lt(o, s) {
    let d = h.blockers.get(o) || Ye;
    L(
  ...
  function tr(o) {
    ...
    if (Pe.size === 0) return;
    Pe.size > 1 && ke(!1, 'A router only supports one blocker at a time');
    let b = Array.from(Pe.entries()),
      [R, S] = b[b.length - 1],
      g = h.blockers.get(R);
    if (
  ...
  function Pt(o) {
    let s = Z(404, { pathname: o }),
      d = c || i,
      { matches: p, route: b } = Rr(d);
    return Dt(), { notFoundMatches: p, route: b, error: s };
  }
  function st(o, s) {
    return {
  ...
  function Dt(o) {
    ...
    return (
      Se.forEach((d, p) => {
        (!o || o(p)) && (d.cancel(), s.push(p), Se.delete(p));
      }),
      s
    );
  }
  function fn(o, s, d) {
    if (((P = o), (B = s), (k = d || null), !Q && h.navigation === Mt)) {
      Q = !0;
      let p = nr(h.location, h.matches);
  ...
  async function ct(o, s, d) {
    ...
    for (;;) {
      ...
      let S = _e(R, s, u);
      if (S) return ar(s, E), { type: 'success', matches: S };
      let g = yt(R, s, u, !0);
      if (
        !g ||
        (p.length === g.length &&
        ...
        return ar(s, E), { type: 'success', matches: null };
      p = g;
    }
  }
  function ar(o, s) {
...
function Ft(e, t, r, n, a, l, i, c) {
  ...
  let m = Bt(a || '.', kt(u, l), tt(e.pathname, r) || e.pathname, c === 'path');
  return (
...
`
  ...
  let u, v;
  if (n.formData) (u = Ut(n.formData)), (v = n.formData);
  else if (n.body instanceof FormData) (u = Ut(n.body)), (v = n.body);
  else if (n.body instanceof URLSearchParams) (u = n.body), (v = gr(u));
  else if (n.body == null) (u = new URLSearchParams()), (v = new FormData());
  else
    try {
      (u = new URLSearchParams(n.body)), (v = gr(u));
    } catch {
      return a();
    }
  let m = {
  ...
  let f = Re(r);
  return (
    t && f.search && $t(f.search) && u.append('index', ''),
    (f.search = '?' + u),
...
function pr(e, t, r, n, a, l, i, c, u, v, m, f, y, O, D, E) {
  ...
  return (
    f.forEach((z, G) => {
      if (l || !r.some((Le) => Le.route.id === z.routeId) || m.has(G)) return;
      let A = _e(O, z.path, D);
      if (!A) {
        h.push({
          key: G,
  ...
  try {
    ...
    if (r.route.lazy)
      if (m) {
        ...
        if (f !== void 0) throw f;
        c = y;
      } else if ((await mr(r.route, a, n), (m = r.route[e]), m)) c = await v(m);
      else if (e === 'action') {
        let f = new URL(t.url),
...
async function Pa(e) {
  ...
  if (Jr(t)) {
    ...
    return r === I.error
      ? {
          type: I.error,
          error: new Ot(t.status, t.statusText, v),
          statusCode: t.status,
          headers: t.headers,
        }
...
function _a(e, t, r, n, a, l) {
  ...
  return (
    r.forEach((y, O) => {
      let D = t[O].route.id;
      if (
        (L(!Me(y), 'Cannot handle redirect results in processLoaderData'),
        re(y))
      ) {
        let E = y.error;
...
function br(e, t, r, n, a, l, i, c) {
  ...
  for (let m = 0; m < l.length; m++) {
    ...
    if (!(O && O.signal.aborted))
      if (re(D)) {
        let E = Ne(e.matches, y == null ? void 0 : y.route.id);
        (v && v[E.route.id]) || (v = H({}, v, { [E.route.id]: D.error })),
          e.fetchers.delete(f);
      } else if (Me(D)) L(!1, 'Unhandled fetcher revalidation redirect');
      else if (Ce(D)) L(!1, 'Unhandled fetcher deferred data');
      else {
        let E = we(D.data);
        e.fetchers.set(f, E);
      }
...
` +
    ...
    new Ot(e || 500, c, new Error(u), !0)
  );
}
function xr(e) {
  for (let t = e.length - 1; t >= 0; t--) {
    let r = e[t];
    if (Me(r)) return { result: r, idx: t };
  }
}
function Vr(e) {
...
function La(e) {
  return Jr(e.result) && pa.has(e.result.status);
}
function Ce(e) {
...
function Xe(e, t) {
  ...
  if (e[e.length - 1].route.index && $t(r || '')) return e[e.length - 1];
  let n = zr(e);
  return n[n.length - 1];
}
function Dr(e) {
...
function rt() {
  return w.useContext(Wt) != null;
}
function Kt() {
  return rt() || L(!1), w.useContext(Wt).location;
}
function Xr(e) {
  w.useContext(ze).static || w.useLayoutEffect(e);
}
function uo() {
  let { isDataRoute: e } = w.useContext(me);
  return e ? Qa() : Na();
}
function Na() {
  rt() || L(!1);
  let e = w.useContext(Ht),
    { basename: t, future: r, navigator: n } = w.useContext(ze),
    { matches: a } = w.useContext(me),
    { pathname: l } = Kt(),
    i = JSON.stringify(kt(a, r.v7_relativeSplatPath)),
    c = w.useRef(!1);
  return (
    Xr(() => {
      c.current = !0;
    ...
    w.useCallback(
      function (v, m) {
        ...
        let f = Bt(v, JSON.parse(i), l, m.relative === 'path');
        e == null &&
          t !== '/' &&
...
function Ba(e) {
  let t = w.useContext(me).outlet;
  return t && w.createElement(ka.Provider, { value: e }, t);
}
function co() {
  let { matches: e } = w.useContext(me),
    t = e[e.length - 1];
  return t ? t.params : {};
}
function za(e, t) {
  let { relative: r } = t === void 0 ? {} : t,
    ...
    { matches: a } = w.useContext(me),
    { pathname: l } = Kt(),
    i = JSON.stringify(kt(a, n.v7_relativeSplatPath));
  return w.useMemo(() => Bt(e, JSON.parse(i), l, r === 'path'), [e, i, l, r]);
}
function fo(e, t, r, n) {
  rt() || L(!1);
  let { navigator: a } = w.useContext(ze),
    { matches: l } = w.useContext(me),
    i = l[l.length - 1],
    c = i ? i.params : {};
  i && i.pathname;
...
function Ka(e) {
  ...
  return (
    ...
    w.createElement(me.Provider, { value: t }, n)
  );
}
function Va(e, t, r, n) {
  var a;
...
function ho() {
  return Rt(Ee.UseRouteId);
}
function po() {
  let { matches: e, loaderData: t } = Vt(Ee.UseMatches);
  return w.useMemo(() => e.map((r) => Nr(r, t)), [e, t]);
}
function vo() {
  let e = Vt(Ee.UseActionData),
    t = Rt(Ee.UseLoaderData);
  return e.actionData ? e.actionData[t] : void 0;
}
function Ga() {
  var e;
  let t = w.useContext(Gr),
    r = Vt(Ee.UseRouteError),
    n = Rt(Ee.UseRouteError);
...
function Qa() {
  let { router: e } = Ja(Qr.UseNavigateStable),
    t = Rt(Ee.UseNavigateStable),
    r = w.useRef(!1);
  return (
    Xr(() => {
      r.current = !0;
...
function go(e) {
  ...
  return E == null
    ...
    : w.createElement(
        ze.Provider,
        { value: v },
        w.createElement(Wt.Provider, { children: r, value: E }),
      );
}
function bo(e) {
...
class Za extends w.Component {
  ...
  render() {
    ...
    if (l === ae.error && a._error instanceof jt) throw qa;
