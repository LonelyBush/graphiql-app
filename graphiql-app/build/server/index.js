...
function ToggleLanguages() {
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$k.toggleControl,
    children: [
      /* @__PURE__ */ jsx('span', {
        className: styles$k.language,
        children: t('En'),
      }),
      /* @__PURE__ */ jsx('button', {
        type: 'button',
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      ...
      /* @__PURE__ */ jsxs('header', {
        className: `${styles$j.header} ${isSticky ? styles$j.sticky : ''}`,
        children: [
          /* @__PURE__ */ jsx(NavLink, {
            to: '/',
            className: ({ isActive }) =>
              isActive ? styles$j.logoActive : styles$j.logo,
          }),
          /* @__PURE__ */ jsxs('nav', {
            className: styles$j.navHeader,
            children: [
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxs('footer', {
    ...
    children: [
      /* @__PURE__ */ jsxs('div', {
        className: styles$i.teamBlock,
        children: [
          /* @__PURE__ */ jsx(FaGithub, { className: styles$i.iconGitHub }),
          /* @__PURE__ */ jsxs('nav', {
            className: styles$i.footerNav,
            children: [
              ' ',
              /* @__PURE__ */ jsx(Link, {
      ...
      /* @__PURE__ */ jsx(Link, {
        to: 'https://rs.school/',
        className: styles$i.linkBlock,
        children: /* @__PURE__ */ jsx('div', { className: styles$i.logoRS }),
      }),
    ],
  });
}
...
function App() {
  return /* @__PURE__ */ jsxs('html', {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx('body', {
        children: /* @__PURE__ */ jsx(ErrorBoundaryComponent, {
...
function Tabs({ defaultSelect = 0, children }) {
  const { t } = useTranslation();
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$e.tabsWrapper,
    children: [
      /* @__PURE__ */ jsx('div', {
        className: styles$e.tabsNavigationSection,
        children: Children.map(children, ({ props: { index, label } }) =>
          /* @__PURE__ */ jsx('button', {
            type: 'button',
            onClick: () => changeTab(index),
            className:
              selected === index
                ? `${styles$e.tabNav} ${styles$e.active}`
                : styles$e.tabNav,
            children: t(label),
          }),
        ),
      ...
      /* @__PURE__ */ jsx('div', {
        className: styles$e.tabContentWrapper,
        children: Children.map(
          children,
          ({ props: { index, children: tabContent2 } }) =>
            selected === index
              ? /* @__PURE__ */ jsx('div', {
                  className: `${styles$e.tabContent} ${styles$e.active}`,
...
function HeadersRedactor({ outerSetHeader }) {
  ...
  const getHeadersJSON = (currentHeaders) => {
    const headersJSON = currentHeaders.reduce((acc, header2) => {
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$d.headersWrapper,
    children: [
      /* @__PURE__ */ jsx(Button, {
        btnType: 'button',
        onClick: handleClick,
        children: t('AddHeader'),
      }),
      headers.length > 0 &&
        /* @__PURE__ */ jsxs('div', {
          className: styles$d.tableHeaders,
          children: [
      ...
      /* @__PURE__ */ jsx('div', {
        'aria-live': 'polite',
        role: 'rowgroup',
        className: styles$d.headersList,
        children: headers.map((header2, index) => {
          return /* @__PURE__ */ jsxs(
            'div',
            {
              className: styles$d.inputSection,
              children: [
                /* @__PURE__ */ jsx('input', {
...
function BodyHeadersTabs({ setBody, setHeaders, params }) {
  const navigate = useNavigate();
  const location = useLocation();
  ...
  const handleEditorDidMount = (editor) => {
    ...
    editor.setValue(
      ((_a = params['*']) == null ? void 0 : _a.split('/')[1]) !== void 0
        ? decodeToString((_b = params['*']) == null ? void 0 : _b.split('/')[1])
        : '',
    );
  };
  useEffect(() => {
    ...
    if (params['*']) {
      ...
      try {
        setBody(
          ((_a = params['*']) == null ? void 0 : _a.split('/')[1]) !== void 0
            ? decodeToString(
                (_b = params['*']) == null ? void 0 : _b.split('/')[1],
              )
            : '',
        );
        setValue(
          ((_c = params['*']) == null ? void 0 : _c.split('/')[1]) !== void 0
            ? decodeToString(
                (_d = params['*']) == null ? void 0 : _d.split('/')[1],
              )
            : '',
        );
      } catch (err) {
  ...
  return /* @__PURE__ */ jsxs(Tabs, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(TabItem, {
        label: t('Headers'),
        index: 1,
        children: /* @__PURE__ */ jsx(HeadersRedactor, {
          outerSetHeader: setHeaders,
        }),
      }),
    ],
  });
...
function Response$1({
  ...
  return /* @__PURE__ */ jsxs('details', {
    className: styles$b.responseBlock,
    children: [
      /* @__PURE__ */ jsxs('summary', {
        className: styles$b.responseSummary,
        children: [
          ...
          responseStatus !== null &&
            /* @__PURE__ */ jsx('span', {
              className:
                responseStatus < 300
                  ? styles$b.responseStatusOk
                  : styles$b.responseStatusError,
              children:
                title2 !== t('DocumentationSDL') &&
                `${t('status')}: ${responseStatus}`,
            }),
        ],
      }),
      /* @__PURE__ */ jsxs('div', {
        className: styles$b.response,
        children: [
          responseStatus === null &&
            !error &&
            /* @__PURE__ */ jsxs(Fragment, {
              children: [
                /* @__PURE__ */ jsx(AiOutlineApi, {
                  color: '#e9c2c5',
                  size: '8rem',
                }),
                /* @__PURE__ */ jsx('h2', {
                  className: styles$b.noResponse,
                  children: t('NoResponse'),
                }),
              ],
            }),
          responseStatus !== null &&
          ...
          error &&
            /* @__PURE__ */ jsxs('div', {
              children: [
                /* @__PURE__ */ jsxs('h3', { children: [t('Error'), ':'] }),
                /* @__PURE__ */ jsx(Editor, {
                  theme: 'vs-dark',
                  loading: 'Loading...',
                  height: '50vh',
...
function RESTFullPage() {
  ...
  const [url, setUrl] = useState(
    ((_a = params['*']) == null ? void 0 : _a.split('/')[0]) || '',
  );
  ...
  const responseStatus =
    (actionData == null ? void 0 : actionData.status) || null;
  ...
  useEffect(() => {
    ...
    if (params['*']) {
      ...
      try {
        setUrl(
          decodeToString(
            (_a2 = params['*']) == null ? void 0 : _a2.split('/')[0],
          ),
        );
      } catch (err) {
        if (err instanceof Error) {
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      /* @__PURE__ */ jsxs('div', {
        className: styles$a.RestBlock,
        children: [
          /* @__PURE__ */ jsx('h2', {
            className: styles$a.title,
            children: t('RESTClient'),
          }),
          /* @__PURE__ */ jsx('div', {
            className: styles$a.methodSection,
            children: /* @__PURE__ */ jsxs(Form, {
              ...
              children: [
                /* @__PURE__ */ jsxs('div', {
                  className: styles$a.methodBlock,
                  children: [
                ...
                /* @__PURE__ */ jsx(Button, {
                  btnType: 'submit',
                  onClick: handleStoreSafe,
                  children: t('Send'),
                }),
              ],
            }),
          }),
          /* @__PURE__ */ jsx(BodyHeadersTabs, {
            params: params || {},
            setHeaders,
            setBody,
          }),
...
function Loading() {
  return /* @__PURE__ */ jsx('section', {
    className: styles$8.loaderContainer,
    children: /* @__PURE__ */ jsx('div', {
...
function SignUpForm() {
  ...
  return loading
    ...
    : /* @__PURE__ */ jsxs('div', {
        className: styles$9.signInFormSection,
        children: [
          /* @__PURE__ */ jsx('h2', { children: t('Registration') }),
          /* @__PURE__ */ jsxs('form', {
            onSubmit: handleSubmit(onSubmit),
            className: styles$9.formWrapper,
            children: [
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs('section', {
        className: styles$7.errorContainer,
        children: [
          /* @__PURE__ */ jsx('span', {
            className: styles$7.spanError,
            children: /* @__PURE__ */ jsx('span', {
              className: styles$7.digitFirst,
              children: '4',
            }),
          }),
          /* @__PURE__ */ jsx('span', {
            className: `${styles$7.spanError} ${styles$7.digitSecond}`,
            children: '0',
          }),
          /* @__PURE__ */ jsx('span', {
            className: styles$7.spanError,
            children: /* @__PURE__ */ jsx('span', {
              className: styles$7.digitThird,
              children: '4',
            }),
          }),
        ],
...
function GraphiqlClient({ requestItem }) {
  const navigate = useNavigate();
  const [searchParams] = useSearchParams();
  const [endpoint, setEndpoint] = useState(
    (requestItem == null ? void 0 : requestItem.requestData.url) ||
      example.endpoint,
  );
  const [sdlEndpoint, setSdlEndpoint] = useState(
    (requestItem == null ? void 0 : requestItem.requestData.sdlUrl) ||
      example.sdlEndpoint,
  );
  const [query, setQuery] = useState(
    print(
      parse(
        (requestItem == null ? void 0 : requestItem.requestData.query) ||
          example.query,
      ),
    ),
  );
  const [variables, setVariables] = useState(
    (requestItem == null ? void 0 : requestItem.requestData.variables) || '{}',
  );
  const [headers, setHeaders] = useState(
    JSON.stringify(JSON.parse(example.headers), null, 2),
  );
  const [response2, setResponse] = useState(null);
  const [responseStatus, setResponseStatus] = useState(null);
  const [responseError, setResponseError] = useState(null);
  const [documentation, setDocumentation] = useState('');
  const [documentationStatus, setDocumentationStatus] = useState(null);
  const [documentationError, setDocumentationError] = useState(null);
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$6.wrapperGraphi,
    children: [
      /* @__PURE__ */ jsx('h2', {
        className: styles$6.title,
        children: t('GraphiQLClient'),
      }),
      /* @__PURE__ */ jsxs('div', {
        className: styles$6.inputContainer,
        children: [
          /* @__PURE__ */ jsxs('div', {
            className: styles$6.inputBlock,
            children: [
              /* @__PURE__ */ jsxs('div', {
                className: styles$6.inputInner,
                children: [
                  /* @__PURE__ */ jsxs('label', {
                    htmlFor: 'endpoint',
                    children: [t('EndpointURL'), ':'],
                  }),
                  /* @__PURE__ */ jsx('input', {
                    id: 'endpoint',
                    type: 'text',
      ...
      /* @__PURE__ */ jsxs('div', {
        children: [
          /* @__PURE__ */ jsxs('label', {
            ...
            children: [t('GraphiQLQueryEditor'), ':'],
          }),
          /* @__PURE__ */ jsx('div', {
            id: 'query-editor',
            children: /* @__PURE__ */ jsx(Editor, {
...
function GraphiQLPage() {
  return /* @__PURE__ */ jsx(GraphiqlClient, {});
}
...
function History() {
  ...
  const restHistory = useSelector((state) => state.restLinks.restLinks);
  ...
  return /* @__PURE__ */ jsx('div', {
    className: styles$5.historyBlock,
    children:
      sortedRequests.length === 0
        ? /* @__PURE__ */ jsxs(Fragment, {
            children: [
              /* @__PURE__ */ jsxs('p', { children: [t('NoHistory'), ' '] }),
              /* @__PURE__ */ jsxs('div', {
                className: styles$5.buttonBlock,
                children: [
                  ' ',
                  /* @__PURE__ */ jsx(Button, {
                    btnType: 'button',
        ...
        : /* @__PURE__ */ jsxs(Fragment, {
            children: [
              ...
              /* @__PURE__ */ jsx('div', {
                className: styles$5.linksBlock,
                children: sortedRequests.map((result) =>
                  /* @__PURE__ */ jsxs(
                    'div',
                    {
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      /* @__PURE__ */ jsxs('article', {
        className: styles$3.cardBlock,
        children: [
          /* @__PURE__ */ jsx('div', {
            className: styles$3.imgBlock,
          ...
          /* @__PURE__ */ jsxs('div', {
            className: styles$3.cardInfoBlock,
            children: [
              /* @__PURE__ */ jsx('h3', {
                className: styles$3.cardName,
                children: t('RomanSokolov'),
              }),
              /* @__PURE__ */ jsx('p', {
...
function AboutComponent() {
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx('div', {
        className: styles$2.aboutUsBlock,
...
function WelcomeComponent() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      /* @__PURE__ */ jsxs('div', {
        className: styles$4.contentInner,
        children: [
          /* @__PURE__ */ jsx('h1', {
            className: styles$4.title,
            children: user
              ? `${t('WelcomeBack')}, ${user == null ? void 0 : user.displayName}!`
              : `${t('Welcome')}!`,
          }),
          /* @__PURE__ */ jsx('p', {
          ...
          /* @__PURE__ */ jsx('div', {
            className: styles$4.buttonBlock,
            children: user
              ? /* @__PURE__ */ jsxs(Fragment, {
                  children: [
                    /* @__PURE__ */ jsx(Button, {
...
function WelcomePage() {
  return /* @__PURE__ */ jsx('div', {
    ...
    children: /* @__PURE__ */ jsx(WelcomeComponent, {}),
  });
}
