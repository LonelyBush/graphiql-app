...
function ToggleLanguages() {
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$j.toggleControl,
    children: [
      /* @__PURE__ */ jsx('span', {
        className: styles$j.language,
        children: t('En'),
      }),
      /* @__PURE__ */ jsx('button', {
        type: 'button',
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      ...
      /* @__PURE__ */ jsxs('header', {
        className: `${styles$i.header} ${isSticky ? styles$i.sticky : ''}`,
        children: [
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxs('footer', {
    ...
    children: [
      /* @__PURE__ */ jsxs('div', {
        className: styles$h.teamBlock,
        children: [
          /* @__PURE__ */ jsx(FaGithub, { className: styles$h.iconGitHub }),
          /* @__PURE__ */ jsxs('nav', {
            className: styles$h.footerNav,
            children: [
              ' ',
              /* @__PURE__ */ jsx(Link, {
                to: 'https://github.com/rs0048',
                className: styles$h.link,
      ...
      /* @__PURE__ */ jsx(Link, {
        to: 'https://rs.school/',
        className: styles$h.linkBlock,
        children: /* @__PURE__ */ jsx('div', { className: styles$h.logoRS }),
      }),
    ],
  });
}
...
function Tabs({ defaultSelect = 0, children }) {
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$c.tabsWrapper,
    children: [
      /* @__PURE__ */ jsx('div', {
        className: styles$c.tabsNavigationSection,
        children: Children.map(children, ({ props: { index, label } }) => {
          return /* @__PURE__ */ jsx('button', {
            ...
            className:
              selected === index
                ? `${styles$c.tabNav} ${styles$c.active}`
                : styles$c.tabNav,
            children: t(label),
          });
        }),
      ...
      /* @__PURE__ */ jsx('div', {
        className: styles$c.tabContentWrapper,
        children: Children.map(children, ({ props: { index, ...props } }) => {
...
function HeadersRedactor({ outerSetHeader }) {
  ...
  return /* @__PURE__ */ jsxs('div', {
    className: styles$b.headersWrapper,
    children: [
      /* @__PURE__ */ jsx(Button, {
        btnType: 'button',
        onClick: handleClick,
      ...
      headers.length > 0 &&
        /* @__PURE__ */ jsxs('div', {
          className: styles$b.tableHeaders,
          children: [
      ...
      /* @__PURE__ */ jsx('div', {
        className: styles$b.headersList,
        children: headers.map((header2, index) => {
          return /* @__PURE__ */ jsxs(
            'div',
            {
              className: styles$b.inputSection,
              children: [
                /* @__PURE__ */ jsx('input', {
...
function Response$1({ responseStatus, response: response2, error }) {
  ...
  return /* @__PURE__ */ jsxs('details', {
    className: styles$9.responseBlock,
    children: [
      /* @__PURE__ */ jsxs('summary', {
        className: styles$9.responseSummary,
        children: [
          /* @__PURE__ */ jsxs('span', { children: [t('Response'), ' '] }),
          responseStatus !== null &&
            /* @__PURE__ */ jsxs('span', {
              className: `${responseStatus < 300 ? styles$9.responseStatusOk : styles$9.responseStatusError}`,
              children: [t('status'), ': ', responseStatus],
            }),
        ],
      }),
      /* @__PURE__ */ jsxs('div', {
        className: styles$9.response,
        children: [
          responseStatus === null &&
            !error &&
            /* @__PURE__ */ jsxs(Fragment, {
...
function RESTFullPage() {
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      /* @__PURE__ */ jsxs('div', {
        className: styles$d.RestBlock,
        children: [
          /* @__PURE__ */ jsx('h2', { children: t('RESTClient') }),
          /* @__PURE__ */ jsx('div', {
            className: styles$d.methodSection,
            children: /* @__PURE__ */ jsxs(Form, {
              ...
              children: [
                /* @__PURE__ */ jsxs('div', {
                  className: styles$d.methodBlock,
                  children: [
...
function Loading() {
  return /* @__PURE__ */ jsx('section', {
    className: styles$7.loaderContainer,
    children: /* @__PURE__ */ jsx('div', {
...
function SignUpForm() {
  ...
  return loading
    ...
    : /* @__PURE__ */ jsxs('div', {
        className: styles$8.signInFormSection,
        children: [
          /* @__PURE__ */ jsx('h2', { children: t('Registration') }),
          /* @__PURE__ */ jsxs('form', {
            onSubmit: handleSubmit(onSubmit),
            className: styles$8.formWrapper,
            children: [
  ...
  return /* @__PURE__ */ jsxs('div', {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs('section', {
        className: styles$6.errorContainer,
        children: [
          /* @__PURE__ */ jsx('span', {
            className: styles$6.spanError,
            children: /* @__PURE__ */ jsx('span', {
              className: styles$6.digitFirst,
              children: '4',
            }),
          }),
          /* @__PURE__ */ jsx('span', {
            className: `${styles$6.spanError} ${styles$6.digitSecond}`,
            children: '0',
          }),
          /* @__PURE__ */ jsx('span', {
            className: styles$6.spanError,
            children: /* @__PURE__ */ jsx('span', {
              className: styles$6.digitThird,
              children: '4',
            }),
          }),
        ],
        ...
        : /* @__PURE__ */ jsxs(Fragment, {
            children: [
              ...
              /* @__PURE__ */ jsx('div', {
                ...
                children: sortedRequests.map((result, index) =>
...
const serverManifest = {
  entry: {
    module: '/assets/entry.client-mwnPJeH2.js',
    imports: ['/assets/index-DeHznlkS.js', '/assets/components-D8uQ7O_9.js'],
    css: [],
  },
  routes: {
    root: {
      ...
      module: '/assets/root-BTf6KPi7.js',
      imports: [
        '/assets/index-DeHznlkS.js',
        '/assets/components-D8uQ7O_9.js',
        '/assets/iconBase-z_erZi_H.js',
        '/assets/rest-history-slice-ClFBwpBo.js',
        '/assets/button-DYUIl9Ir.js',
        '/assets/auth-context-CQxQiTwU.js',
        '/assets/react-redux-ulQB2trU.js',
        '/assets/react-toastify.esm-OaNhFX5r.js',
      ],
      css: ['/assets/button-C2KqssPe.css', '/assets/root-Cdg9RSC8.css'],
    },
    'routes/REST.$method.$': {
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/REST._method._-D0gdg42k.js',
      imports: [
        '/assets/index-DeHznlkS.js',
        '/assets/react-redux-ulQB2trU.js',
        '/assets/button-DYUIl9Ir.js',
      ...
      css: ['/assets/button-C2KqssPe.css', '/assets/REST._method-Y-NZg37x.css'],
    },
    'routes/registration': {
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/registration-DtD-NXTm.js',
      imports: [
        '/assets/index-DeHznlkS.js',
        '/assets/iconBase-z_erZi_H.js',
        '/assets/react-toastify.esm-OaNhFX5r.js',
        '/assets/auth-context-CQxQiTwU.js',
        '/assets/authError-B8rNQ2NH.js',
        '/assets/button-DYUIl9Ir.js',
        '/assets/loading-DSuaqnr6.js',
        '/assets/useAuth-hook-6GkHdI7V.js',
      ],
      css: [
    ...
    'routes/$catchAll': {
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/_catchAll-IDYfxFAU.js',
      imports: ['/assets/index-DeHznlkS.js', '/assets/button-DYUIl9Ir.js'],
    ...
    'routes/history': {
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/history-B24CQrKo.js',
      imports: [
        '/assets/index-DeHznlkS.js',
        '/assets/auth-context-CQxQiTwU.js',
        '/assets/react-redux-ulQB2trU.js',
      ...
      css: ['/assets/button-C2KqssPe.css', '/assets/history-Bq2ZuxCp.css'],
    },
    'routes/_index': {
      id: 'routes/_index',
      parentId: 'root',
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/_index-BVcTRoH5.js',
      imports: [
        '/assets/index-DeHznlkS.js',
        '/assets/auth-context-CQxQiTwU.js',
        '/assets/button-DYUIl9Ir.js',
    ...
    'routes/login': {
      ...
      hasClientLoader: false,
      hasErrorBoundary: false,
      module: '/assets/login-D3QTDWMT.js',
      imports: [
        '/assets/index-DeHznlkS.js',
        '/assets/iconBase-z_erZi_H.js',
        '/assets/react-toastify.esm-OaNhFX5r.js',
  ...
  url: '/assets/manifest-93e981e1.js',
  version: '93e981e1',
};
